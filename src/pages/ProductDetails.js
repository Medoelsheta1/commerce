        ...
        <div className='productDetails m-0 pb-5 pt-5 row gap-20'>
            <div className='left col-lg-6 col-12  row '>
                <div className='imagesContainer  col-2 d-flex flex-column '>
                    <img loading='lazy' src={`${data?.product?.articlesList[0]?.galleryDetails[0]?.baseUrl}`} alt='product_Image1' onClick={() => setImage(0)} />
                    <img loading='lazy' src={`${data?.product?.articlesList[0]?.galleryDetails[1]?.baseUrl}`} alt='product_Image2'onClick={() => setImage(1)} />
                </div>
                <div className='productImage col-10'>
                    <img loading='lazy' src={`${data?.product?.articlesList[0]?.galleryDetails[image]?.baseUrl}`} alt='Product_Image' />
                </div>
            </div>
